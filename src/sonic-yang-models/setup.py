...
setup(
    ...
    data_files=[
        ('yang-models', ['./yang-models/sonic-acl.yang',
                         ...
                         './yang-models/sonic-high-frequency-telemetry.yang',
                         './yang-models/sonic-trimming.yang',
        ...
        ('cvlyang-models', ['./cvlyang-models/sonic-acl.yang',
                         ...
                         './cvlyang-models/sonic-high-frequency-telemetry.yang',
                         './cvlyang-models/sonic-trimming.yang',
